...
- (void)layoutButtonWithEdgeInsetsStyle:(ButtonEdgeInsetsStyle)style imageTitlespace:(CGFloat)space {
    ...
    switch (style) {            
        case ButtonEdgeInsetsStyleBothCenter:
        {
            CGFloat centerX_button = CGRectGetMidX(self.bounds); // bounds
            CGFloat centerX_titleLabel = CGRectGetMidX(self.titleLabel.bounds);
            if (centerX_titleLabel == 0) {
                centerX_titleLabel = labelWidth/2.0;
                titleInsetsLeft -= labelWidth;
            }
            
            CGFloat centerX_image = CGRectGetMidX(self.imageView.bounds);
            ...
            titleInsetsRight = -(centerX_titleLabel - centerX_button);
        }
            break;
            ...
            case ButtonEdgeInsetsStyleImageTop:
        {
            ...
            // add by menghm 20160523
            CGFloat allWidth = CGRectGetWidth(self.frame);
            CGFloat offset = (allWidth-labelWidth)/2.0;
            titleInsetsLeft -= offset;
            titleInsetsRight -= offset;
